...
import vn.mobiletech.rnpushnotification.helpers.ApplicationBadgeHelper;
...
import static vn.mobiletech.rnpushnotification.modules.RNPushNotification.LOG_TAG;
...
public class RNPushNotificationListenerService extends FirebaseMessagingService {
    ...
    private void handleRemotePushNotification(ReactApplicationContext context, Bundle bundle) {
        ...
        // Luatnd: Do not send to
        // if (isForeground != true) {
        Log.v(LOG_TAG, "isBackground > sendToNotificationCentre");
