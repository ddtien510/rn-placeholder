package vn.mobiletech.rnpushnotification.modules;
...
class RNPushNotificationConfig {
    private static final String KEY_CHANNEL_NAME = "vn.mobiletech.rnpushnotification.notification_channel_name";
    private static final String KEY_CHANNEL_DESCRIPTION = "vn.mobiletech.rnpushnotification.notification_channel_description";
    private static final String KEY_NOTIFICATION_COLOR = "vn.mobiletech.rnpushnotification.notification_color";
