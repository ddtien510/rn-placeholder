...
```xml
    ...
    <application ....>
        <meta-data  android:name="vn.mobiletech.rnpushnotification.notification_channel_name"
                android:value="YOUR NOTIFICATION CHANNEL NAME"/>
        <meta-data  android:name="vn.mobiletech.rnpushnotification.notification_channel_description"
                    android:value="YOUR NOTIFICATION CHANNEL DESCRIPTION"/>
        <!-- Change the resource name to your App's accent color - or any other color you want -->
        <meta-data  android:name="vn.mobiletech.rnpushnotification.notification_color"
        ...
        <receiver android:name="vn.mobiletech.rnpushnotification.modules.RNPushNotificationPublisher" />
        <receiver android:name="vn.mobiletech.rnpushnotification.modules.RNPushNotificationBootEventReceiver">
            <intent-filter>
                <action android:name="android.intent.action.BOOT_COMPLETED" />
            </intent-filter>
        </receiver>
        <service android:name="vn.mobiletech.rnpushnotification.modules.RNPushNotificationRegistrationService"/>

        <!-- < Only if you're using GCM or localNotificationSchedule() > -->
        <service
            android:name="vn.mobiletech.rnpushnotification.modules.RNPushNotificationListenerServiceGcm"
        ...
        <!-- < Else > -->
        <service
            android:name="vn.mobiletech.rnpushnotification.modules.RNPushNotificationListenerService"
            android:exported="false" >
            <intent-filter>
...
```gradle
...
include ':rn-push-notification'
project(':rn-push-notification').projectDir = file('../node_modules/rn-push-notification/android')
```
...
```java
import vn.mobiletech.rnpushnotification.RNPushNotificationPackage;  // <--- Import Package
...
public class MainApplication extends Application implements ReactApplication {
  ...
  private final ReactNativeHost mReactNativeHost = new ReactNativeHost(this) {
      ...
      return Arrays.<ReactPackage>asList(
          ...
          new RNPushNotificationPackage() // <---- Add the Package
      );
    }
  };
...
## Usage
```javascript
var PushNotification = require('rn-push-notification');
